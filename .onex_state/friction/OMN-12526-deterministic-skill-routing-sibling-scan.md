...
- Ticket: OMN-12526 (delete dead EnvelopeRouter scaffold in omnibase_core)
- Date: 2026-05-30
- Hook: validate-deterministic-skill-routing (OMN-8765), pass_filenames: false
...
- omniclaude main HEAD (64d7b0b4c, "feat(OMN-12394): preserve autopilot skill orchestrator")
...
- This PR (OMN-12526) modifies zero skill files; it only deletes dead EnvelopeRouter scaffold
...
## Resolution path (out of scope for OMN-12526)
...
pre-existing violations. Tracked separately; OMN-12526 commits with SKIP scoped to ONLY this
