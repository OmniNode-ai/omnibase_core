...
from omnibase.core.models.model_hub_contract_config import (
...
from omnibase.mixin.mixin_debug_discovery_logging import MixinDebugDiscoveryLogging
from omnibase.mixin.mixin_service_registry import MixinServiceRegistry

logger = logging.getLogger(__name__)


class NodeHubBase(NodeBase, MixinServiceRegistry, MixinDebugDiscoveryLogging):
    """
    ...
    def __init__(self, container: ONEXContainer, contract_path: Path):
        ...
        Args:
            container: ONEXContainer from NodeBase
            ...
            if hasattr(self.container, "event_bus_client"):
                try:
                    ...
                    try:
                        ...
                        from omnibase.services.event_bus_client import EventBusClient
