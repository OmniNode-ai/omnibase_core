...
from omnibase.model.core.model_onex_event import ModelOnexEvent
from omnibase.model.discovery.model_output_metadata import ModelOutputMetadata
from omnibase.model.discovery.model_resource_usage import ModelResourceUsage
...
class ModelToolResponseEvent(ModelOnexEvent):
    ...
    event_type: str = Field(
        default=CoreEventTypes.TOOL_RESPONSE,
