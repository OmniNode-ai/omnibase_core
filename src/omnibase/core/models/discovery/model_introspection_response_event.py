...
from omnibase.model.discovery.model_node_introspection_event import (
...
class ModelIntrospectionResponseEvent(ModelOnexEvent):
    ...
    event_type: str = Field(
        default=CoreEventTypes.REAL_TIME_INTROSPECTION_RESPONSE,
    ...
    def create_error_response(
        ...
        **kwargs,
        ...
        return cls(
            ...
            node_name=node_name,
            version=version,
            current_status=NodeCurrentStatusEnum.ERROR,
            capabilities=capabilities,
            response_time_ms=response_time_ms,
