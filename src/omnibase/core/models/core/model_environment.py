...
from omnibase.model.core.model_environment_properties import (
    ModelEnvironmentProperties,
)
from omnibase.model.core.model_feature_flags import ModelFeatureFlags

if TYPE_CHECKING:
    from omnibase.model.configuration.model_resource_limits import ModelResourceLimits
    from omnibase.model.security.model_security_level import ModelSecurityLevel
...
class ModelEnvironment(BaseModel):
    ...
    def create_default(cls, name: str = "development") -> "ModelEnvironment":
        ...
        from omnibase.model.configuration.model_resource_limits import (
            ModelResourceLimits,
        )
