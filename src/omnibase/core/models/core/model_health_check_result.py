...
from omnibase.model.core.model_health_check_component import ModelHealthCheckComponent
...
class ModelHealthCheckResult(BaseModel):
    ...
    queue_connected: Optional[bool] = Field(None, description="Queue connection status")
    ...
    requests_per_second: Optional[float] = Field(
        None, description="Current requests per second"
    )
