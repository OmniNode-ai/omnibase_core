...
OnexEventModelMetadata = ModelOnexEventMetadata
# Backward compatibility alias
OnexEventMetadataModel = ModelOnexEventMetadata
...
from omnibase.constants.event_types import normalize_legacy_event_type
...
# Import the deprecated enum for backwards compatibility
...
try:
    ...
    with warnings.catch_warnings():
        ...
        from omnibase.enums.enum_event_type import OnexEventTypeEnum
