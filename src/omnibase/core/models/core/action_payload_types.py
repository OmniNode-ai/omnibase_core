...
from omnibase.model.core.model_custom_action_payload import ModelCustomActionPayload
from omnibase.model.core.model_data_action_payload import ModelDataActionPayload
from omnibase.model.core.model_filesystem_action_payload import (
    ModelFilesystemActionPayload,
)
from omnibase.model.core.model_lifecycle_action_payload import (
    ModelLifecycleActionPayload,
)
from omnibase.model.core.model_management_action_payload import (
    ModelManagementActionPayload,
)
from omnibase.model.core.model_monitoring_action_payload import (
    ModelMonitoringActionPayload,
)
from omnibase.model.core.model_node_action_type import ModelNodeActionType
from omnibase.model.core.model_operational_action_payload import (
    ModelOperationalActionPayload,
)
from omnibase.model.core.model_registry_action_payload import ModelRegistryActionPayload
from omnibase.model.core.model_transformation_action_payload import (
    ModelTransformationActionPayload,
)
from omnibase.model.core.model_validation_action_payload import (
...
def create_specific_action_payload(
    ...
    """
    from omnibase.model.core.predefined_categories import (
        LIFECYCLE,
        MANAGEMENT,
        OPERATION,
        QUERY,
