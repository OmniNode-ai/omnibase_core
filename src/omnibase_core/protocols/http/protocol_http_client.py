...
Error Handling:
    ...
    Example Error Handling:
        async def safe_health_check(
            ...
            except Exception as e:  # noqa: BLE001  # Example: Catch-all for other HTTP client errors
...
class ProtocolHttpClient(Protocol):
    ...
    # TODO(OMN-5746): Add POST/HEAD/PUT methods if needed for advanced health checks  [NEEDS TICKET]
