...
class ReducerSubreducerRegistry:
    ...
    def register_subreducer(
        ...
        """
        workflow_type_str = workflow_type.value if isinstance(workflow_type, WorkflowType) else str(workflow_type)
    ...
    def get_subreducer(self, workflow_type: WorkflowType) -> Optional[Type[BaseSubreducer]]:
        """
    ...
    def get_subreducer_instance(self, workflow_type: WorkflowType) -> Optional[BaseSubreducer]:
        """
        ...
        for workflow_type_str in self._subreducers:
            try:
                ...
                if instance is None:
                    ...
                    health_status[workflow_type_str] = instance.supports_workflow_type(workflow_type)
            except Exception:
                health_status[workflow_type_str] = False
        
        return health_status
    
    def get_registration_metadata(self, workflow_type: WorkflowType) -> Optional[Dict[str, Any]]:
        """
