...
def _get_connection_pool_class() -> type:
    ...
    # NOTE(OMN-1302): Dynamic import returns module attribute. Safe because redis package installed.
...
def _get_redis_error_class() -> type[Exception]:
    ...
    """
    if REDIS_AVAILABLE:
        # NOTE(OMN-1302): Dynamic import returns exception class. Safe because redis package installed.
