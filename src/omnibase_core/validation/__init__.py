...
class AuditResult:
    def __init__(self, success=True, message="", protocols_found=0):
...
class ProtocolAuditor:
    ...
    def check_current_repository(self):
        return AuditResult(success=True, message="Legacy protocol auditing")

    def check_against_spi(self, spi_path):
...
class ProtocolMigrator:
    def __init__(self, source_path=".", spi_path="../omnibase_spi"):
...
def validate_architecture(
    directory_path: str = "src/", max_violations: int = 0
) -> ValidationResult:
...
def validate_union_usage(
    directory_path: str = "src/", max_unions: int = 100, strict: bool = False
) -> ValidationResult:
...
def validate_patterns(
    directory_path: str = "src/", strict: bool = False
) -> ValidationResult:
...
def validate_all(directory_path: str = "src/", **kwargs) -> dict:
...
def audit_protocols(repository_path: str = "."):
...
def check_against_spi(repository_path: str = ".", spi_path: str = "../omnibase_spi"):
...
def create_migration_plan(source_path: str = ".", spi_path: str = "../omnibase_spi"):
