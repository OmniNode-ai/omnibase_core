...
class ModelLearningTrends(BaseModel):
    ...
    recent_success_rate: float | None = Field(
        default=None,
        description="Success rate of recent attempts",
    )
    older_success_rate: float | None = Field(
        default=None,
        description="Success rate of older attempts",
    )
    improvement_rate: float | None = Field(
        default=None,
        description="Rate of improvement (positive means improving)",
    )
    consistency_score: float | None = Field(
        default=None,
        description="Consistency score (0.0 to 1.0)",
    )
    ...
    trend_confidence: float | None = Field(
        default=None,
        description="Confidence in the trend analysis (0.0 to 1.0)",
    )
