...
class ModelResourceUsage(BaseModel):
    ...
    cpu_percent: Optional[float] = Field(
        None, description="Current CPU usage percentage (0.0-100.0)", ge=0.0, le=100.0
    )
    memory_mb: Optional[float] = Field(
        None, description="Current memory usage in megabytes", ge=0.0
    )
    ...
    disk_usage_percent: Optional[float] = Field(
        None, description="Current disk usage percentage (0.0-100.0)", ge=0.0, le=100.0
    )
    open_files: Optional[int] = Field(
        None, description="Number of open file descriptors", ge=0
    )
    active_connections: Optional[int] = Field(
        None, description="Number of active network connections", ge=0
    )
