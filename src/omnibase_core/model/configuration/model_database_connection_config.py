...
class ModelDatabaseConnectionConfig(BaseModel):
    ...
    def create_production_postgresql(
        ...
        username: str,
        password: str,
        port: int = 5433,  # Non-default port for security
    ) -> "ModelDatabaseConnectionConfig":
        """Create secure production PostgreSQL configuration."""
        return cls(
            host=host,
            port=port,
            database=database,
    ...
    @classmethod
    def create_production_mysql(
        cls,
        host: str,
        database: str,
        username: str,
        password: str,
        port: int = 3307,  # Non-default port for security
    ) -> "ModelDatabaseConnectionConfig":
        """Create secure production MySQL configuration."""
        return cls(
            host=host,
            port=port,
            database=database,
    ...
    def create_testing(
        ...
        return cls(
            ...
            ssl_enabled=False,
            connection_timeout=5,  # Fast timeout for tests
        )
