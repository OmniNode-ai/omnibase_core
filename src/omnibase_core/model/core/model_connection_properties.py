...
class ModelConnectionProperties(BaseModel):
    ...
    db_schema: str | None = Field(None, description="Default schema")

    # Authentication
    username: str | None = Field(None, description="Username")
    password: SecretStr | None = Field(None, description="Password")
    ...
    pool_recycle: int | None = Field(None, description="Connection recycle time")

    # Timeout settings
    connect_timeout: int | None = Field(None, description="Connection timeout")
    socket_timeout: int | None = Field(None, description="Socket timeout")
