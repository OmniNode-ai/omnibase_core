...
class ToolMissingReason(str, Enum):
...
class ModelMissingTool(BaseModel):
    ...
    def is_critical_tool(self) -> bool:
        ...
        return self.criticality == ToolCriticality.CRITICAL

    def is_high_priority_tool(self) -> bool:
        """Check if this is a high priority tool."""
        return self.criticality in [ToolCriticality.CRITICAL, ToolCriticality.HIGH]

    def is_core_tool(self) -> bool:
        """Check if this is a core system tool."""
        return self.tool_category == ToolCategory.CORE

    def is_integration_tool(self) -> bool:
        """Check if this is an integration tool."""
        return self.tool_category == ToolCategory.INTEGRATION

    def requires_immediate_attention(self) -> bool:
        """Check if this missing tool requires immediate attention."""
        return (
            self.is_critical_tool()
            or self.reason_category == ToolMissingReason.PERMISSION_DENIED
            or (self.business_impact_score and self.business_impact_score > 0.8)
        )
    ...
    def _is_recoverable_error(self) -> bool:
        ...
        recoverable_reasons = [
            ToolMissingReason.CONFIGURATION_INVALID,
            ToolMissingReason.DEPENDENCY_MISSING,
            ToolMissingReason.PERMISSION_DENIED,
            ToolMissingReason.IMPORT_ERROR,
        ]
    ...
    def _requires_code_change(self) -> bool:
        ...
        code_change_reasons = [
            ...
            ToolMissingReason.CIRCULAR_DEPENDENCY,
    ...
    def get_recovery_recommendations(self) -> List[str]:
        ...
        elif self.reason_category == ToolMissingReason.IMPORT_ERROR:
        ...
        elif self.reason_category == ToolMissingReason.PERMISSION_DENIED:
    ...
    def calculate_business_impact_score(self) -> float:
        ...
        criticality_scores = {
            ToolCriticality.CRITICAL: 1.0,
            ToolCriticality.HIGH: 0.8,
            ToolCriticality.MEDIUM: 0.5,
            ToolCriticality.LOW: 0.3,
            ToolCriticality.OPTIONAL: 0.1,
        }
        ...
        category_multipliers = {
            ...
            ToolCategory.SECURITY: 0.9,
            ToolCategory.INTEGRATION: 0.8,
            ToolCategory.BUSINESS_LOGIC: 0.7,
            ToolCategory.VALIDATION: 0.6,
            ToolCategory.MONITORING: 0.5,
            ToolCategory.PERFORMANCE: 0.5,
            ToolCategory.DATA_PROCESSING: 0.6,
            ToolCategory.EXTERNAL_SERVICE: 0.7,
            ToolCategory.UTILITY: 0.3,
        }
    ...
    def create_not_found(
        ...
        return cls(
            ...
            reason_category=ToolMissingReason.NOT_FOUND,
    ...
    def create_type_mismatch(
        ...
        return cls(
            ...
            reason_category=ToolMissingReason.TYPE_MISMATCH,
            criticality=criticality,
    ...
    def create_import_error(
        ...
        return cls(
            ...
            reason_category=ToolMissingReason.IMPORT_ERROR,
    ...
    def create_permission_denied(
        ...
        tool_name: str,
        expected_type: str,
        criticality: ToolCriticality = ToolCriticality.HIGH,
    ) -> "ModelMissingTool":
        ...
        return cls(
            ...
            expected_type=expected_type,
            reason_category=ToolMissingReason.PERMISSION_DENIED,
            criticality=criticality,
            tool_category=ToolCategory.SECURITY,
    ...
    def create_dependency_missing(
        ...
        return cls(
            ...
            expected_type=expected_type,
            reason_category=ToolMissingReason.DEPENDENCY_MISSING,
    ...
    def create_from_exception(
        ...
        if "ImportError" in error_type or "ModuleNotFoundError" in error_type:
            ...
            reason_category = ToolMissingReason.INSTANTIATION_FAILED
