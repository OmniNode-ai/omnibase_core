...
class ModelMetadataToolCollection(RootModel[Dict[str, Any]]):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if "_metadata_analytics" not in self.root:
            self.root["_metadata_analytics"] = ModelMetadataToolAnalytics().model_dump()
    ...
    def add_tool(
        ...
        Args:
            name: Tool name
            tool_data: Tool data (ModelFunctionTool, dict, etc.)
        ...
        try:
            ...
            if tool_info:
                ...
                default_info = ModelMetadataToolInfo(name=name)
                if "_tool_info" not in self.root:
                    self.root["_tool_info"] = {}
    ...
    def deprecate_tool(
        ...
        tool_info.status = MetadataToolStatus.DEPRECATED
        ...
        for name, tool in tools_dict.items():
            if hasattr(tool, "name") and hasattr(tool, "description"):
                tool_info = ModelMetadataToolInfo(
                    ...
                    tool_type=MetadataToolType.FUNCTION,
                )
