...
from omnibase_core.model.service.model_custom_fields import ModelCustomFields
from omnibase_core.model.service.model_retry_strategy import ModelRetryStrategy
...
class ModelEventBusInputState(BaseModel):
    ...
    def create_basic(cls, version: str, input_field: str) -> "ModelEventBusInputState":
        ...
        return cls(version=ModelSemVer.parse(version), input_field=input_field)
