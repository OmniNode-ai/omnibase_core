...
class KubernetesTemplateGenerator:
    ...
    def generate_configmap(self) -> dict[str, Any]:
        ...
        return {
            ...
            "data": {"service-config.json": json.dumps(self.config.model_dump(), indent=2)},
        }
...
def generate_deployment_templates(
    ...
    docker_gen = DockerTemplateGenerator(service_config)
    ...
    k8s_gen = KubernetesTemplateGenerator(service_config)
