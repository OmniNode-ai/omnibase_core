...
@unique
class EnumAssignmentStatus(UtilStrValueHelper, str, Enum):
...
@unique
class EnumExecutionPattern(UtilStrValueHelper, str, Enum):
...
@unique
class EnumFailureRecoveryStrategy(UtilStrValueHelper, str, Enum):
