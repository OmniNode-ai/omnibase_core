...
This module provides type-safe YAML loading that uses yaml.safe_load combined with
Pydantic model validation to ensure proper structure and security.
...
def load_and_validate_yaml_model(path: Path, model_cls: type[T]) -> T:
    ...
    try:
        ...
        raise OnexError(
            ...
            operation="load_and_validate_yaml_model",
            path=str(path),
        )
...
def load_yaml_content_as_model(content: str, model_cls: type[T]) -> T:
    ...
    try:
        ...
        raise OnexError(
            ...
            error_code=CoreErrorCode.VALIDATION_ERROR,
            operation="load_yaml_content_as_model",
        )
    except yaml.YAMLError as e:
        raise OnexError(
    ...
    **yaml_options: Any,
    ...
    try:
        ...
        raise OnexError(
            ...
            error_code=CoreErrorCode.INTERNAL_ERROR,
            operation="serialize_pydantic_model_to_yaml",
        )
    ...
    **yaml_options: Any,
    ...
    try:
        ...
        raise OnexError(
            ...
            error_code=CoreErrorCode.INTERNAL_ERROR,
            operation="serialize_data_to_yaml",
        )
    ...
    try:
        ...
        if not examples:
            raise OnexError(
                ...
                error_code=CoreErrorCode.VALIDATION_ERROR,
                operation="extract_example_from_schema",
