...
class ModelDetectionConfiguration(BaseModel):
    ...
    def is_ruleset_enabled(self, ruleset_id: str) -> bool:
        """Check if a ruleset is enabled."""
        return ruleset_id in self.enabled_rulesets

    def enable_ruleset(self, ruleset_id: str) -> "ModelDetectionConfiguration":
        """Enable a ruleset."""
    ...
    def disable_ruleset(self, ruleset_id: str) -> "ModelDetectionConfiguration":
        """Disable a ruleset."""
