...
class ModelSecureEventEnvelope(ModelEventEnvelope[ModelOnexEvent]):
    ...
    def add_signature(self, signature: ModelNodeSignature) -> None:
        ...
        # TODO(OMN-5746): Consider adding envelope_version to ModelNodeSignature if needed.  # onex-allow-todo-marker OMN-5746 reason="signature-schema follow-up is separately tracked"
