...
from omnibase_core.models.optimization.model_optimization_metadata import (
    ModelOptimizationMetadata,
)
from omnibase_core.models.optimization.model_reallocation import ModelReallocation
...
class ModelOptimizationResult(BaseModel):
    ...
    reallocations: list[ModelReallocation] = Field(
        ...
        description="Quota reallocations performed",
    )
    ...
    efficiency_before: float = Field(
        ...
        ge=0,
        le=1,
        description="Efficiency before optimization",
    )
    efficiency_after: float = Field(
        ...,
        ge=0,
        le=1,
        description="Efficiency after optimization",
    )
    ...
    metadata: ModelOptimizationMetadata | None = Field(
