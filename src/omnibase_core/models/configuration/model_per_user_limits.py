...
class ModelPerUserLimits(BaseModel):
    ...
    def get_user_limit(self, user_id: str, user_tier: str | None = None) -> int:
        ...
        # Check individual user overrides first
    ...
    def get_user_burst_capacity(self, user_id: str, base_limit: int) -> int:
        """Get burst capacity for a specific user"""
        # Check user-specific burst first
    ...
    def should_escalate_user(self, user_id: str, trust_score: float) -> bool:
    ...
    def add_user_override(self, user_id: str, limit: int) -> None:
        """Add individual user override"""
        self.individual_user_overrides[user_id] = limit

    def remove_user_override(self, user_id: str) -> None:
    ...
    def block_user(self, user_id: str) -> None:
        ...
        # Remove from unlimited if present
        if user_id in self.unlimited_users:
    ...
    def grant_unlimited_access(self, user_id: str) -> None:
    ...
    def revoke_unlimited_access(self, user_id: str) -> None:
    ...
    def create_ip_based_limits(cls) -> "ModelPerUserLimits":
        ...
        return cls(
            enabled=True,
            default_user_limit=100,
            anonymous_user_limit=100,  # Same as default for IP-based
            user_identification_method="ip_address",
            escalation_enabled=False,  # Trust scores harder to establish for IPs
