...
Note: Each class is defined in its own file following ONEX single-class-per-file
convention. This module provides backward-compatible re-exports.
"""
...
from omnibase_core.models.common.model_graph_node_inputs import ModelGraphNodeInputs
