...
from omnibase_core.models.llm.model_llm_function_call import ModelLLMFunctionCall
from omnibase_core.models.llm.model_llm_tool_call import ModelLLMToolCall
