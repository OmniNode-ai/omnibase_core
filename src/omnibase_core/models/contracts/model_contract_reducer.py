...
class ModelContractReducer(ModelContractBase):
    ...
    def validate_node_type_architecture(cls, v: object) -> EnumNodeType:
        ...
        Examples:
            >>> validate_node_type_architecture("reducer")
            EnumNodeType.REDUCER_GENERIC
            >>> validate_node_type_architecture("REDUCER_GENERIC")
            EnumNodeType.REDUCER_GENERIC
            >>> validate_node_type_architecture(EnumNodeType.REDUCER_GENERIC)
            EnumNodeType.REDUCER_GENERIC
        """
