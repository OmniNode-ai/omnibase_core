...
from omnibase_core.enums import EnumNodeArchitectureType
...
class ModelContractOrchestrator(ModelContractBase):
    ...
    def validate_node_type_architecture(cls, v: object) -> EnumNodeType:
        ...
        - EnumNodeArchitectureType enum values (mapped to ORCHESTRATOR_GENERIC)
        - EnumNodeType enum values (passed through unchanged)
        - Lowercase architecture type strings: "compute", "effect", "reducer", "orchestrator"
        - Valid EnumNodeType string values (e.g., "ORCHESTRATOR_GENERIC")
        ...
        Examples:
            >>> validate_node_type_architecture("orchestrator")
            EnumNodeType.ORCHESTRATOR_GENERIC
            >>> validate_node_type_architecture("ORCHESTRATOR_GENERIC")
            EnumNodeType.ORCHESTRATOR_GENERIC
            >>> validate_node_type_architecture(EnumNodeType.ORCHESTRATOR_GENERIC)
            EnumNodeType.ORCHESTRATOR_GENERIC
        """
