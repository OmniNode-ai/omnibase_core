...
from omnibase_core.models.health.model_tool_health import (
    ModelToolHealth,
    ToolHealthStatus,
)
from omnibase_core.models.service.model_service_health import (
    ModelServiceHealth,
    ServiceHealthStatus,
)
...
class ModelRegistryHealthReport(BaseModel):
    ...
    def get_monitoring_metrics(self) -> ModelMonitoringMetrics:
        ...
        from omnibase_core.models.core.model_monitoring_metrics import MetricValue
