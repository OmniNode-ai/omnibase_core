...
from omnibase_core.models.semantic.model_query_analysis import ModelQueryAnalysis
from omnibase_core.models.semantic.model_retrieval_operation_statistics import (
    ModelRetrievalOperationStatistics,
)
from omnibase_core.models.semantic.model_retrieved_document import (
...
class ModelRetrievalOutputState(OnexOutputState):
    ...
    query_analysis: ModelQueryAnalysis = Field(
        description="Analysis of the input query",
        default_factory=ModelQueryAnalysis,
    )

    bm25_results_count: int = Field(
        default=0,
        description="Number of results from BM25 retrieval",
    )
    ...
    fusion_method: str | None = Field(
        default=None,
        description="Method used to combine retrieval results",
    )
