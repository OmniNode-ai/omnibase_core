...
class ModelMetadataUsageMetrics(BaseModel):
    ...
    def get_metadata(self) -> ModelTypedDictUsageMetadataDict:
        """Get metadata as dict[str, Any]ionary (ProtocolMetadataProvider protocol)."""
        metadata: ModelTypedDictUsageMetadataDict = ModelTypedDictUsageMetadataDict()
    ...
    def set_metadata(self, metadata: ModelTypedDictUsageMetadataDict) -> bool:
