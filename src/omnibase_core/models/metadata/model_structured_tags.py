...
Reduces reliance on unstructured string tag lists.
"""
...
from omnibase_core.helpers.uuid_helpers import uuid_from_string
...
class ModelStructuredTags(BaseModel):
    ...
    def from_string_list(
        ...
        """Create structured tags from string list."""
        structured = cls(
