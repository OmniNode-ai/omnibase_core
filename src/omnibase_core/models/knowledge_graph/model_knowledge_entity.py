...
from omnibase_core.models.knowledge_graph.model_entity_metadata import (
    ModelEntityMetadata,
)
from omnibase_core.models.knowledge_graph.model_entity_type import ModelEntityType
