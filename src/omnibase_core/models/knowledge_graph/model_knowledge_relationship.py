...
from omnibase_core.models.knowledge_graph.model_relationship_evidence import (
    ModelRelationshipEvidence,
)
from omnibase_core.models.knowledge_graph.model_relationship_type import (
...
class ModelKnowledgeRelationship(BaseModel):
    ...
    reverse_relationship_type: str | None = Field(
        None,
        description="Type when traversed in reverse",
    )
