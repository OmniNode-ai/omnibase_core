...
class ModelStorageCredentials(BaseModel):
    ...
    password: Optional[SecretStr] = Field(
        description="Password for authentication (secure)",
        default=None,
    )

    api_key: Optional[SecretStr] = Field(
        description="API key for authentication (secure)",
        default=None,
    )

    token: Optional[SecretStr] = Field(
        description="Bearer token for authentication (secure)",
        default=None,
    )

    connection_string: Optional[SecretStr] = Field(
        description="Complete connection string (secure)",
        default=None,
    )
