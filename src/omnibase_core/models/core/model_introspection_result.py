...
from omnibase_core.models.nodes.model_node_health_status import ModelNodeHealthStatus
...
class ModelIntrospectionResult(BaseModel):
    ...
    health: ModelNodeHealthStatus = Field(description="Node health status")
