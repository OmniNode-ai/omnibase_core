"""
Node Type Model (Individual)

Replaces EnumNodeType with a proper model that includes metadata,
descriptions, and categorization for each node type.
Now uses strongly typed enums for enhanced type safety.
"""

from pydantic import BaseModel, Field

from omnibase_core.enums.nodes import EnumNodeCategory, EnumNodeOutputType
...
class ModelNodeType(BaseModel):
    ...
    Now uses strongly typed enums for improved type safety.
    """
    ...
    category: EnumNodeCategory = Field(
        ...,
        description="Node category for organization (strongly typed)",
    )
    ...
    output_type: EnumNodeOutputType | None = Field(
        default=None,
        description="Type of output produced (strongly typed)",
    )
    ...
    def CONTRACT_TO_MODEL(cls) -> "ModelNodeType":
        ...
        return cls(
            ...
            category=EnumNodeCategory.GENERATION,
            is_generator=True,
            requires_contract=True,
            output_type=EnumNodeOutputType.MODELS,
        )
    ...
    def GENERATE_ERROR_CODES(cls) -> "ModelNodeType":
        ...
        return cls(
            ...
            is_generator=True,
            requires_contract=True,
            output_type=EnumNodeOutputType.ENUMS,
        )
    ...
    def GENERATE_INTROSPECTION(cls) -> "ModelNodeType":
        ...
        return cls(
            ...
            category=EnumNodeCategory.GENERATION,
            is_generator=True,
            output_type=EnumNodeOutputType.METADATA,
        )
    ...
    def NODE_GENERATOR(cls) -> "ModelNodeType":
        ...
        return cls(
            ...
            output_type=EnumNodeOutputType.NODE,
        )
    ...
    def TEMPLATE_ENGINE(cls) -> "ModelNodeType":
        ...
        return cls(
            ...
            category=EnumNodeCategory.TEMPLATE,
            is_generator=True,
            output_type=EnumNodeOutputType.TEXT,
        )
    ...
    def FILE_GENERATOR(cls) -> "ModelNodeType":
        ...
        return cls(
            ...
            output_type=EnumNodeOutputType.FILES,
        )
    ...
    def TEMPLATE_VALIDATOR(cls) -> "ModelNodeType":
        ...
        return cls(
            ...
            category=EnumNodeCategory.VALIDATION,
            is_validator=True,
            output_type=EnumNodeOutputType.REPORT,
        )
    ...
    def STANDARDS_COMPLIANCE_FIXER(cls) -> "ModelNodeType":
        ...
        return cls(
            ...
            category=EnumNodeCategory.MAINTENANCE,
            is_generator=True,
            is_validator=True,
            output_type=EnumNodeOutputType.FIXES,
        )
    ...
    def PARITY_VALIDATOR_WITH_FIXES(cls) -> "ModelNodeType":
        ...
        return cls(
            ...
            is_validator=True,
            is_generator=True,
            output_type=EnumNodeOutputType.REPORT_AND_FIXES,
        )
    ...
    def CLI_COMMANDS(cls) -> "ModelNodeType":
        ...
        return cls(
            ...
            category=EnumNodeCategory.CLI,
            is_generator=True,
            output_type=EnumNodeOutputType.COMMANDS,
        )
    ...
    def NODE_DISCOVERY(cls) -> "ModelNodeType":
        ...
        return cls(
            ...
            category=EnumNodeCategory.DISCOVERY,
            execution_priority=95,
            output_type=EnumNodeOutputType.NODES,
        )
    ...
    def SCHEMA_GENERATOR(cls) -> "ModelNodeType":
        ...
        return cls(
            ...
            category=EnumNodeCategory.SCHEMA,
            is_generator=True,
            output_type=EnumNodeOutputType.SCHEMAS,
        )
    ...
    def PROTOCOL_GENERATOR(cls) -> "ModelNodeType":
        ...
        return cls(
            ...
            category=EnumNodeCategory.GENERATION,
            is_generator=True,
            output_type=EnumNodeOutputType.PROTOCOLS,
        )
    ...
    def BACKEND_SELECTION(cls) -> "ModelNodeType":
        ...
        return cls(
            ...
            category=EnumNodeCategory.RUNTIME,
            output_type=EnumNodeOutputType.BACKEND,
        )
    ...
    def NODE_MANAGER_RUNNER(cls) -> "ModelNodeType":
        ...
        return cls(
            ...
            output_type=EnumNodeOutputType.RESULT,
        )
    ...
    def MAINTENANCE(cls) -> "ModelNodeType":
        ...
        return cls(
            ...
            category=EnumNodeCategory.MAINTENANCE,
            output_type=EnumNodeOutputType.STATUS,
        )
    ...
    def LOGGER_EMIT_LOG_EVENT(cls) -> "ModelNodeType":
        ...
        return cls(
            name="node_logger_emit_log_event",  # Keep original name
            description="Emits structured log events",
            category=EnumNodeCategory.LOGGING,
            output_type=EnumNodeOutputType.LOGS,
        )
    ...
    def SCENARIO_RUNNER(cls) -> "ModelNodeType":
        ...
        return cls(
            ...
            category=EnumNodeCategory.TESTING,
            output_type=EnumNodeOutputType.RESULTS,
        )
    ...
    def from_string(cls, name: str) -> "ModelNodeType":
        ...
        if factory:
            return factory()
        # Unknown node type - create generic with strongly typed enum
        return cls(
            name=name,
            description=f"Node: {name}",
            category=EnumNodeCategory.UNKNOWN,
        )
