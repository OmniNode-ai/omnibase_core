...
class ModelNodeAction(ModelActionBase):
    """
    Structured node action model with node-as-a-service support.
    ...
    # Node-as-a-Service enhancements
    ...
    def to_service_metadata(
        ...
        """Generate service metadata for node discovery with strong typing."""
        return {
