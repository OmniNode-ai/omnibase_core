...
class model_file_operation_rollback_data(BaseModel):
    ...
    content: str | None = Field(
        None,
        description="Content to write or that was written",
    )
    ...
    create_backup: bool = Field(
        default=True,
        description="Whether to create backup before operation",
    )

    file_existed: bool = Field(
        default=False,
        description="Whether file existed before operation",
    )
