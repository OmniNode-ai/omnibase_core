    ...
    def create_onex_service_dockerfile(
        ...
        runtime_stage = ModelDockerBuildStage(
            ...
            copy_commands=[
                ...
                {
                    "source": "src/omnibase_core/core/",
                    "destination": "./src/omnibase_core/core/",
                    "chown": "onex:onex",
                },
                {
                    "source": "src/omnibase_core/enums/",
                    "destination": "./src/omnibase_core/enums/",
                    "chown": "onex:onex",
                },
                {
                    "source": "src/omnibase_core/protocol/",
                    "destination": "./src/omnibase_core/protocol/",
                    "chown": "onex:onex",
                },
                {
                    "source": "src/omnibase_core/models/",
                    "destination": "./src/omnibase_core/models/",
                    "chown": "onex:onex",
                },
                {
                    "source": "src/omnibase_core/registry/",
                    "destination": "./src/omnibase_core/registry/",
                    "chown": "onex:onex",
                },
                {
                    "source": "src/omnibase_core/utils/",
                    "destination": "./src/omnibase_core/utils/",
                    "chown": "onex:onex",
                },
                {
                    "source": f"src/omnibase_core/{service_group}/",
                    "destination": f"./src/omnibase_core/{service_group}/",
                    "chown": "onex:onex",
                },
            ],
            env=runtime_env,
