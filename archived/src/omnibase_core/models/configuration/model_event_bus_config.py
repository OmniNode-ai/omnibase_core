...
class ModelModelEventBusConfig(BaseModel):
    """
    ...
    def apply_environment_overrides(self) -> "ModelModelEventBusConfig":
        ...
        if overrides:
            ...
            return ModelModelEventBusConfig(**current_data)

        return self

    @classmethod
    def default(cls) -> "ModelModelEventBusConfig":
        """
