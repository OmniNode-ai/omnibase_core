...
from omnibase_core.models.core.model_missing_tool import (
    ModelMissingTool,
    ToolCriticality,
)
...
class ModelRegistryValidationResult(BaseModel):
    ...
    def get_missing_tools_by_category(self) -> dict[str, list[ModelMissingTool]]:
        ...
        from omnibase_core.models.core.model_missing_tool import ToolCategory
    ...
    def get_monitoring_metrics(self) -> "ModelMonitoringMetrics":
        ...
        custom_metrics = {
            "validation_id": MetricValue(
                value=(
                    str(self.metadata.custom_fields.get("validation_id", "unknown"))
                    if self.metadata and self.metadata.custom_fields
                    else "unknown"
                ),
            ),
