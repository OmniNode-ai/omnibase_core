...
class ModelSignatureChain(BaseModel):
    ...
    validation_status: ChainValidationStatus = Field(
        default=ChainValidationStatus.INCOMPLETE,
    ...
    def add_signature(
        ...
        try:
            ...
            # Re-raise OnexError for proper error handling
            raise
    ...
    def validate_chain_integrity(self) -> bool:
        ...
        try:
            if not self.signatures:
                self.validation_status = ChainValidationStatus.INCOMPLETE
                return False
            ...
            for i, signature in enumerate(self.signatures):
                ...
                if i == 0:
                    ...
                    if signature.previous_signature_hash != expected_hash:
                        self.validation_status = ChainValidationStatus.TAMPERED
                        return False
            ...
            self.validation_status = ChainValidationStatus.VALID
            return True
    ...
    def has_complete_route(self) -> bool:
        ...
        return (
            NodeOperationEnum.SOURCE in operations
    ...
    def detect_anomalies(self) -> list[str]:
        ...
        operations = {sig.operation for sig in self.signatures}
        if NodeOperationEnum.SOURCE not in operations:
    ...
    def create_new_chain(
        ...
        return cls(
            ...
            validation_status=ChainValidationStatus.INCOMPLETE,
