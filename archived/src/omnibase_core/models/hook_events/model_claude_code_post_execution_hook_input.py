...
Technical Notes:
    ...
    - All optional fields default to None for current standards
...
from omnibase_core.models.claude_code_responses import ClaudeCodeToolResponseUnion
...
class ModelClaudeCodePostExecutionHookInput(BaseModel):
    ...
    Attributes:
        ...
        topic: Event bus topic or routing information
    ...
    tool_response: ClaudeCodeToolResponseUnion | None = Field(
        None,
