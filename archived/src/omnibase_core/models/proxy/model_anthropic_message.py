...
from omnibase_core.models.proxy.model_anthropic_tool_use_content import (
    ModelAnthropicToolUseContent,
)
from omnibase_core.models.proxy.model_anthropic_usage import ModelAnthropicUsage
