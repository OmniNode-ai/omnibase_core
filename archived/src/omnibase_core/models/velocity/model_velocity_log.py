...
from omnibase_core.models.velocity.model_velocity_context import ModelVelocityContext
from omnibase_core.models.velocity.model_velocity_metrics import ModelVelocityMetrics
...
class ModelVelocityLog(BaseModel):
    ...
    context: ModelVelocityContext = Field(
        default_factory=lambda: ModelVelocityContext(),
