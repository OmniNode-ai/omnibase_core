...
Example:
    Using with local vLLM server::
        ...
        client = LocalLLMClient(
            endpoint_url="http://localhost:8000",  # url-authority-ok: local demo endpoint # onex-allow-internal-ip OMN-17524 reason="supported local demo example"
...
DEFAULT_ENDPOINT = "http://localhost:8000"  # url-authority-ok: local demo default # onex-allow-internal-ip OMN-17524 reason="supported local demo default"
