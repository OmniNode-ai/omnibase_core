...
class _LocalProviderConfig(BaseModel):  # type: ignore[explicit-any]
    ...
    default_endpoint: str = "http://localhost:8000"  # url-authority-ok: local demo default # onex-allow-internal-ip OMN-17524 reason="supported local demo default"  # fallback-ok: local demo default
    ...
    Example:
        Create a local provider config::
            ...
            config = ModelConfig(
                ...
                endpoint_url=os.getenv("LOCAL_LLM_ENDPOINT", "http://localhost:8000"),  # url-authority-ok: local demo example # onex-allow-internal-ip OMN-17524 reason="supported local demo example"
            )
    """
...
LOCAL_CONFIG = ModelConfig(
    ...
    endpoint_url=os.getenv("LOCAL_LLM_ENDPOINT", "http://localhost:8000"),  # url-authority-ok: local demo default # onex-allow-internal-ip OMN-17524 reason="supported local demo default" # fallback-ok: local demo default
)
