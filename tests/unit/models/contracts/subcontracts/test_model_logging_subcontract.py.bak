...
class TestModelLoggingSubcontractValidation:
    ...
    def test_log_format_invalid_value_raises_error(self):
        ...
        with pytest.raises(ModelOnexError) as exc_info:
            ModelLoggingSubcontract(log_format="xml")
    ...
    def test_performance_threshold_constraints(self):
        ...
        # Valid values
        subcontract = ModelLoggingSubcontract(performance_threshold_ms=1)
        assert subcontract.performance_threshold_ms == 1

        subcontract = ModelLoggingSubcontract(performance_threshold_ms=30000)
        assert subcontract.performance_threshold_ms == 30000

        # Exceeds recommended threshold
        with pytest.raises(ModelOnexError) as exc_info:
            ModelLoggingSubcontract(performance_threshold_ms=40000)
    ...
    def test_sampling_rate_constraints(self):
        ...
        # Valid values
        subcontract = ModelLoggingSubcontract(sampling_rate=0.01)
        assert subcontract.sampling_rate == 0.01

        subcontract = ModelLoggingSubcontract(sampling_rate=1.0)
        assert subcontract.sampling_rate == 1.0

        # Below minimum recommended
        with pytest.raises(ModelOnexError) as exc_info:
            ModelLoggingSubcontract(sampling_rate=0.001)
    ...
    def test_max_log_entry_size_constraints(self):
        ...
        # Valid values
        subcontract = ModelLoggingSubcontract(max_log_entry_size_kb=1)
        assert subcontract.max_log_entry_size_kb == 1

        subcontract = ModelLoggingSubcontract(max_log_entry_size_kb=512)
        assert subcontract.max_log_entry_size_kb == 512

        # Exceeds recommended threshold
        with pytest.raises(ModelOnexError) as exc_info:
            ModelLoggingSubcontract(max_log_entry_size_kb=600)
    ...
    def test_log_buffer_size_constraints(self):
        ...
        # Valid values
        subcontract = ModelLoggingSubcontract(log_buffer_size=100)
        assert subcontract.log_buffer_size == 100

        subcontract = ModelLoggingSubcontract(log_buffer_size=10000)
...
class TestModelLoggingSubcontractEdgeCases:
    ...
    def test_empty_sensitive_field_patterns(self):
        ...
        subcontract = ModelLoggingSubcontract(sensitive_field_patterns=[])
    ...
    def test_custom_sensitive_field_patterns(self):
        ...
        subcontract = ModelLoggingSubcontract(sensitive_field_patterns=custom_patterns)
...
class TestModelLoggingSubcontractAttributes:
    ...
    def test_logging_subcontract_copy(self):
        ...
        subcontract = ModelLoggingSubcontract(log_level="ERROR")
    ...
    def test_logging_subcontract_equality(self):
        ...
        subcontract1 = ModelLoggingSubcontract(log_level="WARNING")
        subcontract2 = ModelLoggingSubcontract(log_level="WARNING")
