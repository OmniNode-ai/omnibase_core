...
class TestEnumInstanceType:
    ...
    def test_is_azure_instance(self):
        ...
        assert (
            EnumInstanceType.is_azure_instance(EnumInstanceType.GCP_F1_MICRO) is False
        )
    ...
    def test_is_gcp_instance(self):
        ...
        assert (
            EnumInstanceType.is_gcp_instance(EnumInstanceType.GCP_N1_STANDARD_2) is True
        )
    ...
    def test_is_database_instance(self):
        ...
        assert (
            EnumInstanceType.is_database_instance(EnumInstanceType.DB_T2_MICRO) is True
        )
        assert (
            EnumInstanceType.is_database_instance(EnumInstanceType.DB_T3_MEDIUM) is True
        )

        # Non-database instances
        assert EnumInstanceType.is_database_instance(EnumInstanceType.T2_MICRO) is False
        assert (
            EnumInstanceType.is_database_instance(EnumInstanceType.CONTAINER_SMALL)
            is False
        )
    ...
    def test_is_container_instance(self):
        ...
        assert (
            EnumInstanceType.is_container_instance(EnumInstanceType.CONTAINER_SMALL)
            is True
        )
        assert (
            EnumInstanceType.is_container_instance(EnumInstanceType.CONTAINER_XLARGE)
            is True
        )

        # Non-container instances
        assert (
            EnumInstanceType.is_container_instance(EnumInstanceType.T2_MICRO) is False
        )
        assert (
            EnumInstanceType.is_container_instance(EnumInstanceType.DB_T2_MICRO)
            is False
        )
    ...
    def test_get_size_category(self):
        ...
        assert (
            EnumInstanceType.get_size_category(EnumInstanceType.GCP_F1_MICRO) == "micro"
        )
        assert (
            EnumInstanceType.get_size_category(EnumInstanceType.DB_T2_MICRO) == "micro"
        )
        ...
        assert (
            EnumInstanceType.get_size_category(EnumInstanceType.CONTAINER_SMALL)
            == "small"
        )

        # Medium instances
        assert (
            EnumInstanceType.get_size_category(EnumInstanceType.T2_MEDIUM) == "medium"
        )
        ...
        # XLarge instances
        assert (
            EnumInstanceType.get_size_category(EnumInstanceType.T3_XLARGE) == "xlarge"
        )
        assert (
            EnumInstanceType.get_size_category(EnumInstanceType.M5_2XLARGE) == "xlarge"
        )
    ...
    def test_comprehensive_coverage(self):
        ...
        assert (
            len(container_instances) >= 4
        )  # Should have reasonable container coverage
