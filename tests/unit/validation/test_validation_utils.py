...
class TestPathValidation:
    ...
    def test_validate_nonexistent_directory(self):
        ...
        with pytest.raises(ExceptionInputValidation, match="does not exist"):
    ...
    def test_validate_file_as_directory(self):
        ...
        with tempfile.NamedTemporaryFile() as temp_file:
            ...
            with pytest.raises(ExceptionInputValidation, match="not a directory"):
    ...
    def test_validate_directory_as_file(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with pytest.raises(ExceptionInputValidation, match="not a file"):
...
class TestInvalidPathHandling:
    ...
    def test_validate_directory_with_invalid_path(self, monkeypatch):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with pytest.raises(ExceptionInputValidation, match="Invalid"):
                validate_directory_path(temp_path, "test")
