...
class TestSubreducerRegistration:
    ...
    def test_register_subreducer_router_failure(self, engine):
        ...
        engine._router.register_subreducer = MagicMock(side_effect=OnexError("test error"))
...
class TestWorkflowProcessing:
    ...
    @pytest.mark.asyncio
    async def test_successful_workflow_processing(self, engine, sample_workflow_request):
    ...
    @pytest.mark.asyncio
    async def test_workflow_processing_no_subreducer(self, engine, sample_workflow_request):
