...
class ContractValidator:
    ...
    def _validate_core_services(self) -> bool:
        ...
        core_services = [
            (
                ...
                "omnibase_core.protocol.protocol_service_discovery",
            ),
            (
                "ProtocolDatabaseConnection",
                "omnibase_core.protocol.protocol_database_connection",
            ),
        ]
    ...
    def _validate_protocol_contract(
        ...
        try:
            ...
            if not (
                hasattr(protocol_class, "__protocol__")
                or isinstance(protocol_class, _ProtocolMeta)
            ):
