...
the hardcoded-topic cleanup plan in the umbrella `omni_home` docs is execution
context; the current topic guard is the Core topic validator described here.
