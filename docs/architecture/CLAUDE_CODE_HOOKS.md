...
> **Why in core?** These hook models are part of the shared contract surface used by multiple repos (omniclaude, omniintelligence, etc.). They define the canonical event types for Claude Code integration.
