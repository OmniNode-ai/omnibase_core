...
- [CLAUDE.md - Key Patterns](../../../CLAUDE.md) - Project conventions
- [Enum Naming Conventions](../../conventions/) - Naming standards
- [ONEX Four-Node Architecture](../ONEX_FOUR_NODE_ARCHITECTURE.md) - Node lifecycle context
